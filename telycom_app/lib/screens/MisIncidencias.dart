...
class _MisIncidenciasState extends State<MisIncidencias>{
  ...
  Future<Position> _determinePosition() async {
    ...
    if (permission == LocationPermission.deniedForever) {
      showSnackBar('Location permissions are permantly denied, we cannot request permissions.');
      return Future.error(
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission != LocationPermission.whileInUse &&
        ...
        showSnackBar('Location permissions are denied (actual value: $permission).');
        return Future.error(
  ...
  void reloadMapWithGPSPosition() {
    // esto es un callback, determina nuestra posición
    posicionActual.onError((error, stackTrace){
      print("Sejodio");
      return null;
    });
